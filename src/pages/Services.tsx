                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-1.5 py-2">
                      <a
                        ...
                        className="p-2 rounded-xl bg-[#E1306C]/20 border border-[#E1306C]/40 text-[#E1306C] hover:bg-[#E1306C] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center"
                        title="Instagram"
                      >
                      ...
                      <a
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="p-2 rounded-xl bg-[#1877F2]/20 border border-[#1877F2]/40 text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center"
                        title="Facebook"
                      >
                      ...
                      <a
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="p-2 rounded-xl bg-[#0A66C2]/20 border border-[#0A66C2]/40 text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center"
                        title="LinkedIn"
                      >
                      ...
                      <a
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="p-2 rounded-xl bg-[#FF0000]/20 border border-[#FF0000]/40 text-[#FF0000] hover:bg-[#FF0000] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center"
                        title="YouTube"
                      >
